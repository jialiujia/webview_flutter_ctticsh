...
public class WebViewHostApiImpl implements GeneratedAndroidWebView.WebViewHostApi {
  ...
  public static class WebViewPlatformView extends WebView implements PlatformView, Releasable {
    ...
    public void setWebViewClient(WebViewClient webViewClient) {
      ...
      currentWebViewClient.set((WebViewClientHostApiImpl.ReleasableWebViewClient) webViewClient);

      final WebChromeClientHostApiImpl.WebChromeClientImpl webChromeClient = currentWebChromeClient.get();
      if (webChromeClient != null) {
        ((WebChromeClientHostApiImpl.WebChromeClientImpl) webChromeClient).setWebViewClient(webViewClient);
      }
    }
    ...
    public void setDownloadListener(DownloadListener listener) {
      ...
      currentDownloadListener.set((DownloadListenerHostApiImpl.DownloadListenerImpl) listener);
    }

    @Override
    public void setWebChromeClient(WebChromeClient client) {
      super.setWebChromeClient(client);
      currentWebChromeClient.set((WebChromeClientHostApiImpl.WebChromeClientImpl) client);
    }
